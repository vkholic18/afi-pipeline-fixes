...
${PATH_TO_GENCTL_CI}/onepipeline/scripts/trigger_subpipeline_v11.sh "brt-as-subpipeline" "taas-worker-trigger" "false" "onepipeline/pipelines/templatized/razee/pr_master_v11/.pipeline-config-subpipeline-configurations.yaml"
...
${PATH_TO_GENCTL_CI}/onepipeline/scripts/trigger_subpipeline_v11.sh "deploy-ngdc-as-subpipeline" "deploy-ngdc-trigger" "false" "onepipeline/pipelines/templatized/razee/pr_master_v11/.pipeline-config-subpipeline-configurations.yaml"
