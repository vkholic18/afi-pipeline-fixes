...
# CANDIDATE_FILES_ZIP_FILE_NAME_PREFIX
...
then
    echo "This script checks that the deployment ZIP file is on place for commit ${GIT_SHA}"
...
BASE_PATH_TO_CHECK="${ARTIFACTORY_BASE_URL}/${ARTIFACTORY_GENERIC_SANDBOX_REPO_PATH}/${CANDIDATE_FILES_PRE_RELEASE_DIR}/${ORG_AND_REPO}"
