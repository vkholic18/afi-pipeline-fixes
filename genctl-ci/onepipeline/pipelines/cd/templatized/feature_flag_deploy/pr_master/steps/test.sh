...
######## VALIDATE FEATUREFLAGS SCHEMA ########

print_divider
run_task ${SET_GHE_STATUSES} ${CHECKS_PREFIX} "validate-feature-schema" ${EXIT_ON_TASK_FAILURE} \
${PATH_TO_GENCTL_CI}/scripts/validate_feature_flag_schema.sh
print_divider