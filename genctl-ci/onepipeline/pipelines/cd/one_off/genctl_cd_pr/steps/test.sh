...
### Bob AI PR review — runs before tests so it is not skipped by an earlier job failure ###
# Uses EXIT_ON_JOB_FAILURE="false" so it never blocks the real test jobs below.
run_job "BOB_PR_REVIEW" "false" \
