...
if has_s390x_packages_data; then
    ...
    ${PATH_TO_GENCTL_CI}/onepipeline/scripts/build_s390x_packages.sh "onepipeline/pipelines/templatized/artifacts/pr_v11/.pipeline-config-subpipeline-s390x-artifacts.yaml"
else
