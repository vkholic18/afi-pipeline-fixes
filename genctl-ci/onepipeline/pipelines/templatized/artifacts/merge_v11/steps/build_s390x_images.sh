...
if check_yaml_path_has_data "images.multi_arch"; then
    ...
    ${PATH_TO_GENCTL_CI}/onepipeline/scripts/build_s390x_images.sh "onepipeline/pipelines/templatized/artifacts/merge_v11/.pipeline-config-subpipeline-s390x-artifacts.yaml"
else
