...
${PATH_TO_GENCTL_CI}/onepipeline/jobs/release_bundles_ngdc_deploy.sh "onepipeline/pipelines/templatized/release_bundles/pr_with_rias_smoke_v11/.pipeline-config-subpipeline-brt-deploy-dal.yaml"
