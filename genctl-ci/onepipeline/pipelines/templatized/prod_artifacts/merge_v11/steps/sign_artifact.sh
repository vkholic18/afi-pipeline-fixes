...
${PATH_TO_GENCTL_CI}/onepipeline/scripts/signing_v11.sh "onepipeline/pipelines/templatized/prod_artifacts/merge_v11/.pipeline-config-subpipeline-signing.yaml"
