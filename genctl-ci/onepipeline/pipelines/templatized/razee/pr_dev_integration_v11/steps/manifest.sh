...
## Create manifest
run_job "MANIFEST" ${EXIT_ON_JOB_FAILURE} \
${PATH_TO_GENCTL_CI}/onepipeline/jobs/manifest.sh

## Copy third party images (Validation is done in all scans) ##
...
## Copy third party images for ICR if required ##
