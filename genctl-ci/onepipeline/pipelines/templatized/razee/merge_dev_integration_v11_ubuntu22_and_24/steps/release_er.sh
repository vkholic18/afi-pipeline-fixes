...
run_task ${SET_GHE_STATUSES} ${CHECKS_PREFIX} "UPLOAD_DEPLOYMENT_FILES" ${EXIT_ON_TASK_FAILURE} \
${PATH_TO_GENCTL_CI}/onepipeline/scripts/inventory_candidate_files/upload_deployment_files.sh
