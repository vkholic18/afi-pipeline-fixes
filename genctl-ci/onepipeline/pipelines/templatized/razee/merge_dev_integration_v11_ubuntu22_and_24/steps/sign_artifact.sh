...
${PATH_TO_GENCTL_CI}/onepipeline/scripts/signing_v11.sh "onepipeline/pipelines/templatized/razee/merge_dev_integration_v11_ubuntu22_and_24/.pipeline-config-subpipeline-signing.yaml"
