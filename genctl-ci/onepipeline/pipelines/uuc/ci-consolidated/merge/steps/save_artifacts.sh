...
# Set the flag that exits if the job failed
export EXIT_ON_JOB_FAILURE="true"

### non-standard image generation ###
run_job "GENERATE_NON_STANDARD_IMAGES_FILES" ${EXIT_ON_JOB_FAILURE} \
${PATH_TO_GENCTL_CI}/onepipeline/jobs/generate_non_stanadard_image_files.sh

run_job "NON_STANDARD_IMAGE_COPY" ${EXIT_ON_JOB_FAILURE} \
${PATH_TO_GENCTL_CI}/onepipeline/jobs/non_standarad_image_copy.sh
