...
# Set the flag that indicates if set EOTF when running task
...
"${PATH_TO_GENCTL_CI}/onepipeline/scripts/build_s390x_images.sh" \
"onepipeline/pipelines/one_off/cocoa_image_merge_v11/.cocoa-config-subpipeline-s390x.yaml"